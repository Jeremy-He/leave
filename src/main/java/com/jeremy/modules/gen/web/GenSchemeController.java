...
package com.jeremy.modules.gen.web;
...
import com.jeremy.modules.gen.service.GenSchemeService;
import com.jeremy.modules.gen.service.GenTableService;
import com.jeremy.modules.gen.util.GenUtils;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.jeremy.modules");//("com.jeremy.modules");
		}
...
//	@RequestMapping(value = "save")
//	public String save2(GenScheme genScheme, Model model, HttpServletRequest request, HttpServletResponse response) {
//		if (!beanValidator(model, genScheme)){
//			return form(genScheme, model);
//		}
//		
//		FileUtils.deleteDirectory(Global.getProjectPath() + File.separator);
//		String result = genSchemeService.save(genScheme);
//		String descFileName = Global.getProjectPath() + File.separator + genScheme.getModuleName()+".zip";
//		FileUtils.deleteDirectory(descFileName);
//		//addMessage(redirectAttributes, "操作生成方案'" + genScheme.getName() + "'成功<br/>"+result);
//		FileUtils.zipFiles(Global.getProjectPath() + File.separator, "src", descFileName);
//		FileUtils.downFile(new File(descFileName), request, response, genScheme.getModuleName()+".zip");
//		Servlets.setFileDownloadHeader(response, genScheme.getModuleName()+".zip");
//		return null;
//	}	
	
//	//文件下载形式
//	@RequestMapping(value = "save")
//	public String save(GenScheme genScheme, Model model, HttpServletRequest request, HttpServletResponse response) {
//		if (!beanValidator(model, genScheme)){
//			return form(genScheme, model);
//		}
//		String descFileName = Global.getProjectPath() + File.separator + genScheme.getModuleName()+".zip";
