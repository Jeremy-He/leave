...
import com.jeremy.modules.sys.dao.MenuDao;
import com.jeremy.modules.sys.dao.RoleDao;
import com.jeremy.modules.sys.dao.UserDao;
import com.jeremy.modules.sys.entity.Menu;
...
import com.jeremy.modules.sys.utils.LogUtils;
...
import com.jeremy.common.security.Digests;
import com.jeremy.common.security.shiro.session.SessionDAO;
import com.jeremy.common.service.BaseService;
import com.jeremy.common.service.ServiceException;
import com.jeremy.common.utils.CacheUtils;
import com.jeremy.common.utils.Encodes;
...
import com.jeremy.modules.sys.entity.Role;
import com.jeremy.modules.sys.entity.User;
import com.jeremy.modules.sys.security.SystemAuthorizingRealm;
import com.jeremy.modules.sys.utils.LogUtils;
import com.jeremy.modules.sys.utils.UserUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public Page<User> findUser(Page<User> page, User user) {
		...
		dataScopeFilter(user, "id=o.id", "id=a.create_by", "sys:user:view");
		// 设置分页参数
		user.setPage(page);
		// 执行分页查询
	...
	public List<User> findUser(User user){
		// 生成数据权限过滤条件（dsf为dataScopeFilter的简写，在xml中使用 ${sqlMap.dsf}调用权限SQL）
		dataScopeFilter(user, "id=o.office_id", "id=a.create_by", "sys:user:view");
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By Jeremy\r\n");
		sb.append("\r\n======================================================================\r\n");
